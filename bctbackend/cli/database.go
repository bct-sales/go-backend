...
func resetDatabaseAndFillWithDummyData(databasePath string) (r_err error) {
	...
	queries.AddItem(db, 1, "Puma sneakers", 2000, defs.Shoes, 200, false, false, true)
	queries.AddItem(db, 1, "Reebok sneakers", 2000, defs.Shoes, 200, false, true, false)
	queries.AddItem(db, 1, "Converse sneakers", 2000, defs.Shoes, 200, true, false, false)
	queries.AddItem(db, 1, "Vans sneakers", 2000, defs.Shoes, 200, true, true, false)
