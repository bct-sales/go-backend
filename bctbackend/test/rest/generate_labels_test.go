...
func TestGenerateLabels(t *testing.T) {
	defaultLayout := server.Layout{
		PaperWidth:   210,
		PaperHeight:  297,
		PaperMargins: server.Insets{Top: 10, Bottom: 10, Left: 10, Right: 10},
		Columns:      2,
		Rows:         10,
		LabelMargins: server.Insets{Top: 10, Bottom: 10, Left: 10, Right: 10},
		LabelPadding: server.Insets{Top: 10, Bottom: 10, Left: 10, Right: 10},
		FontSize:     12,
	}
